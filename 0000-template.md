...
- Fabric-X Component: (fill me in with underlined fabric component, core, orderer/consensus and etc.)
...
Explain the proposal as if it was already included in Fabric-X and you were
teaching it to another Fabric-X developer. That generally means:

- Introducing new named concepts.
- Explaining the feature largely in terms of examples.
- Explaining how Fabric-X programmers should *think* about the feature, and how
...
that Fabric-X sometimes intentionally diverges from common distributed
...
Hyperledger Fabric-X components.  Dependencies upon RFCs or issues should be recorded as 
